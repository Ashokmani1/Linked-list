...
# printing Length
print()
print("length of the linked list : " + str(myList.length()))

# printing index of an element
print()
print("Getting 3 Element in the Linked list : " + str(myList.index(3)))

# printing element at a particular index
print()
print("Getting 5 Element in the Linked list : " + str(myList.atIndex(5)))
...
print()
print("After removing paticular position linked list elements are ")

myList.display()

# printing max and min element
print()
print("max element " + str(myList.Max()))

print()
print("min element in list " + str(myList.Min()))

# pushing and poping elements
print()
print("Pusing and poping the element in linked list")
myList.push(31)
myList.display()
print(myList.pop())
myList.display()
...
print()
print("creating a copy of the Linked List")
myList2 = myList.copy()
myList2.display()

# removing all elements from the LinkedList
print()
print("removing all elements from the LinkedList")
myList2.clear()
myList2.display()
...
print()
print("printing a string of elements of the LinkedList")
print(myList.toString(","))

# printing count of particular element in the List
print()
print("printing count of particular element in the List")
...
print()
print("making a List from the LinkedList")
newSet = myList.toSet()
print(newSet)

# reversing the LinkedLkst
print()
print("reversing the LinkedLkst")
myList.reverse()
myList.display()

# making a sorted LinkedList out of the Original
print()
print("making a sorted LinkedList out of the Original")
